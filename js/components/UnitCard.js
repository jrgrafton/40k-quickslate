    ...
    expanded && wargearAbilities.length > 0 && h("div", { className: "wargear-section" },
      ...
      ...wargearAbilities.map((wa, i) =>
        h("div", { key: i, className: "wargear-item" },
          ...
          wa.description && h("div", { className: "wargear-desc" }, ...highlightKeywords(stripHtml(wa.description))),
        )
      ),
    ),
      ...
      h("div", { className: "abilities-section" },
        ...
        ...parsedData.enhancements.map((enh, i) =>
          h("div", { key: 'enh' + i, style: { marginBottom: 4 } },
            ...
            enh.description && h("div", { className: "ability-desc", style: { whiteSpace: 'pre-line' } }, ...highlightKeywords(stripHtml(enh.description))),
          )
        )
      ),
      ...
      h("div", { className: "abilities-section" },
        ...
        ...abilities.map((a, i) =>
          h("div", { key: i, style: { marginBottom: 4 } },
            ...
            (a.description || a.desc) && h("div", { className: "ability-desc" }, ...highlightKeywords(stripHtml(a.description || a.desc || ''))),
          )
        )
      ),
